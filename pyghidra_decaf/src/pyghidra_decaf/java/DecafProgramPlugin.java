...
public abstract class DecafProgramPlugin extends ProgramPlugin {

	// set via reflection
	// DecafPlugin handlers
    ...
    private Consumer<Program> handle_programActivated = (Program program) -> {};
    private Consumer<Program> handle_postProgramActivated = (Program program) -> {};
    private Consumer<Program> handle_programClosed = (Program program) -> {};
    private Consumer<Program> handle_programOpened = (Program program) -> {};
    private Consumer<Program> handle_programDeactivated = (Program program) -> {};
    private Consumer<ProgramLocation> handle_locationChanged = (ProgramLocation loc) -> {};
    private Consumer<ProgramSelection> handle_selectionChanged = (ProgramSelection loc) -> {};
    private Consumer<ProgramSelection> handle_highlightChanged = (ProgramSelection loc) -> {};

	public DecafProgramPlugin(PluginTool tool) {
		super(tool);
	}

	// ================ BEGIN Plugin.class HANDLERS ===================
	...
	protected void programActivated(Program program) {
		this.handle_programActivated.accept(program);
	}
	...
	protected void postProgramActivated(Program program) {
		this.handle_postProgramActivated.accept(program);
	}
	...
	protected void programClosed(Program program) {
		this.handle_programClosed.accept(program);
	}
	...
	protected void programOpened(Program program) {
		this.handle_programOpened.accept(program);
	}
	...
	protected void programDeactivated(Program program) {
		this.handle_programDeactivated.accept(program);
	}
	...
	protected void locationChanged(ProgramLocation loc) {
		this.handle_locationChanged.accept(loc);
	}
	...
	protected void selectionChanged(ProgramSelection sel) {
		this.handle_selectionChanged.accept(sel);
	}
	...
	protected void highlightChanged(ProgramSelection hl) {
		this.handle_highlightChanged.accept(hl);
	}
}
